...
BENCHMARKS = {
    "compensation": {
        ...
        "items": [
            {"label": "평균 성과급 비율", "value": "기본급 대비 15~25%", "note": "귀사 현재: 응답 기반 해석"},
            {"label": "시장 보상 수준", "value": "중위 50~75%ile", "note": "귀사 현재: 응답 기반 해석"},
            {"label": "인건비 / 매출 비중", "value": "25~35%", "note": "귀사 현재: 응답 기반 해석"},
            {"label": "보상 구조 트렌드", "value": "밴드형 + 분기 성과급", "note": "성장기 스타트업에서 주로 검토"},
        ],
    ...
    "evaluation": {
        "title": "50~100인 B2B SaaS 기준",
        "items": [
            {"label": "평가 주기", "value": "분기 OKR + 반기 공식 리뷰", "note": "연 1회는 소수"},
            {"label": "평가-보상 연동", "value": "중간~강한 연동 (60%)", "note": "완전 분리는 10% 미만"},
            {"label": "대표-직원 공정성 갭", "value": "1점 이내 (10점 척도)", "note": "1점 = 주의, 2점+ = 즉시 대응"},
            {"label": "평가 운영 데이터 보유율", "value": "55%", "note": "나머지는 수기 또는 미보유"},
        ],
    ...
    "recruitment": {
        "title": "50~100인 B2B SaaS 기준",
        "items": [
            {"label": "핵심 포지션 채용 소요", "value": "2~3개월", "note": "4개월 초과 시 경쟁력 저하"},
            {"label": "활용 채널 수", "value": "3~4개", "note": "리퍼럴 + 플랫폼 2개 + α"},
            {"label": "오퍼 수락률", "value": "75~85%", "note": "70% 미만이면 경쟁력 문제"},
            {"label": "채용 비용 / 인당", "value": "300~500만 원", "note": "헤드헌터 사용 시 1,000만+"},
        ],
    ...
    "retention": {
        "title": "50~100인 B2B SaaS 기준",
        "items": [
            {"label": "자발적 이직률", "value": "12~18% / 연", "note": "20% 초과 시 위험"},
            {"label": "핵심 인재 이탈률", "value": "5% 이하", "note": "10% 초과 시 조직 역량 훼손"},
            {"label": "신규 입사자 1년 내 퇴사", "value": "15~20%", "note": "30% 초과 시 온보딩 실패"},
            {"label": "퇴직 인터뷰 실시율", "value": "40%", "note": "체계적 실시는 소수"},
        ],
    ...
    "leadership": {
        "title": "50~100인 B2B SaaS 기준",
        "items": [
            {"label": "정기 1on1 운영률", "value": "60~70%", "note": "격주 이상이 표준"},
            {"label": "리더십 교육 투자", "value": "연 1~2회 외부 교육", "note": "체계적 코칭은 소수"},
            {"label": "CEO 직접 면접 비율", "value": "시니어/C-Level만", "note": "전원 면접은 30인 이하에서만 적합"},
            {"label": "핵심가치 행동 기준 보유", "value": "35%", "note": "대부분 선언적 수준"},
        ],
