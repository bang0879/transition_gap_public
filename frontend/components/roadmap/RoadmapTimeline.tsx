...
const OPERATING_REFERENCES: Record<string, string> = {
  performance: "Netflix식 고성과, 고책임 운영 이미지를 참고합니다. 단, 보상 차등은 평가 기준 공개, 리더 캘리브레이션, 피드백 기록이 갖춰진 범위에서만 확대합니다.",
  community: "Google식 심리적 안전감, 협업 운영 이미지를 참고합니다. 격주 1on1, 온보딩 체크포인트, 팀 단위 인센티브를 먼저 정기 운영화하고 고성과자 동기 저하 신호를 별도로 추적합니다.",
  elite: "초기 토스식 소수정예, 빠른 실행 운영 이미지를 참고합니다. 핵심 인재 정의, 전결권 위임, 별도 보상 밴드를 함께 설계하고 형평성 리스크를 의사결정 표에 남깁니다.",
};
