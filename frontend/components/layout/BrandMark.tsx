  ...
  return (
    <div className="flex min-w-0 items-center gap-3">
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="shrink-0">
        ...
        <path d="M20 9.5h-6.5c-3 0-5.5 2.4-5.5 5.4v3.6" stroke="var(--teal-deep)" strokeWidth="2" strokeLinecap="round" opacity="0.5" />
        <path d="M10.5 7 8 9.5l2.5 2.5M17.5 7 20 9.5 17.5 12" stroke="var(--teal-deep)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
